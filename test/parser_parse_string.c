...
static MunitResult test_parse_string(const MunitParameter params[], void *data) {
    ...
    formula_token *token_empty = parse_string(empty);
    ...
    munit_assert_ushort(TYPE_TOKEN_STRING, ==, token_empty->type);
